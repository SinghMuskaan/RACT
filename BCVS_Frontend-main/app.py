...
def graphs():
    # path_to_static_folder=os.path.join(os.getcwd(), "static")
    # path_to_graphs_folder = os.path.join(path_to_static_folder, "Graphs")
    graphs_file_paths = [os.path.join('static\\Graphs', file) for file in os.listdir('static\\Graphs')]
    graphs_file_keywords = [file.replace('.png', '').replace('_','') for file in os.listdir('static\\Graphs')]
